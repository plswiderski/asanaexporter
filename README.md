...
You can download built project from https://pablo127.bitbucket.io/asanaexporter/asanaexporter-all-1.0.3.jar

## Run
Run exporter by:

`java -jar asanaexporter-all-1.0.3.jar $personalAccessToken`
